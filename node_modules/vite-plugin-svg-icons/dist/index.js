...
// node_modules/fast-glob/node_modules/braces/lib/utils.js
...
// node_modules/fast-glob/node_modules/braces/lib/stringify.js
...
// node_modules/fast-glob/node_modules/is-number/index.js
...
// node_modules/fast-glob/node_modules/to-regex-range/index.js
...
// node_modules/fast-glob/node_modules/fill-range/index.js
...
// node_modules/fast-glob/node_modules/braces/lib/compile.js
...
// node_modules/fast-glob/node_modules/braces/lib/expand.js
...
// node_modules/fast-glob/node_modules/braces/lib/constants.js
...
// node_modules/fast-glob/node_modules/braces/lib/parse.js
...
// node_modules/fast-glob/node_modules/braces/index.js
...
var _etag = require('etag'); var _etag2 = _interopRequireDefault(_etag);
...
// src/constants.ts
var SVG_ICONS_NAME = "vite-plugin-svg-icons/register";
var SVG_ICONS_CLIENT = ["vite-plugin-svg-icons/client", "virtual:svg-icons-names"];
var SVG_DOM_ID = "__svg__icons__dom__" + new Date().getTime() + "__";

// src/index.ts
var _vite = require('vite');
var _svgbaker = require('svg-baker'); var _svgbaker2 = _interopRequireDefault(_svgbaker);
var debug = _debug.debug.call(void 0, "vite-plugin-svg-icons");
var src_default = (opt) => {
  const cache = new Map();
  let isBuild = false;
  ...
  return {
    ...
    configureServer: ({middlewares}) => {
      middlewares.use(async (req, res, next) => {
        const url = _vite.normalizePath.call(void 0, req.url);
        ...
        if ([...clientIds, registerId].some((item) => url.endsWith(item))) {
          ...
          res.setHeader("Etag", _etag2.default.call(void 0, content, {weak: true}));
          res.statusCode = 200;
          res.end(content);
        } else {
          next();
...
async function compilerIcons(cache, svgOptions, options) {
  ...
  for (const dir of iconDirs) {
    const svgFilsStats = import_fast_glob.default.sync("**/*.svg", {cwd: dir, stats: true, absolute: true});
    for (const entry of svgFilsStats) {
      ...
      const getSymbol = async () => {
        relativeName = _vite.normalizePath.call(void 0, path2).replace(_vite.normalizePath.call(void 0, dir + "/"), "");
...
async function compilerIcon(file, symbolId, svgOptions) {
  ...
  let content = _fsextra2.default.readFileSync(file, "utf-8");
  if (svgOptions) {
    const {data} = await _svgo.optimize.call(void 0, content, svgOptions);
    content = data;
  }
...
function createSymbolId(name, options) {
  ...
  return id.replace(_path2.default.extname(id), "");
}
function discreteDir(name) {
  if (!_vite.normalizePath.call(void 0, name).includes("/")) {
    return {
      fileName: name,
      dirName: ""
    };
...
exports.compilerIcon = compilerIcon; exports.compilerIcons = compilerIcons; exports.createModuleCode = createModuleCode; exports.createSymbolId = createSymbolId; exports.default = src_default; exports.discreteDir = discreteDir;
